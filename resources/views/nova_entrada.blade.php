    ...
    <div class="col-md-12 p-3">
       <form method="POST" action="{{route('processa')}}">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="descricao" id="descricao" class="form-control" placeholder="Digite a descrição do movimento">              
            </div>
            ...
            <div class="form-check form-check-inline">
              ...
              <div class="form-check form-check-inline">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" name="valor" required id="valor" class="form-control" step="0.1" placeholder="Digite o valor">
                </div>
